...
<head>
  ...
  <title>Valemobi - Cadastro de tipo de negócio</title>
...
<body class="container">
		<nav class="row navbar navbar-inverse">
			<div class="row-fluid">
				<div class="col-xs-12 font-white">
					<h1>Cadastro de tipo de negócio</h1>
				</div>
			</div>
		</nav>
		...
		<div>
			...
			<div class="form-group form-group-sm">
				<label for="tipoNegocio">Nome: </label>
				<input type="text" class="form-control" name="nome" id="tipoNegocio" placeholder="Digite o tipo de Negócio" required/>
  		</div>
	...
	<script src="<?php echo $dado["baseUrl"] ?>view/js/tipoNegocio.js"></script>
